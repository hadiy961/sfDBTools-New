...
var CmdCopyTable = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		for i, table := range sourceTables {
			...
			_, _, err = svc.CopyTable(ctx, profile, sourceDB, table, targetDB, currTargetTable, copyTableSchemaOnly, copyTableForce, copyTableBackupFirst, copyTableIncludeGrants, copyTableNonInteractive)
