...
port="3306"
daily_backup_path="/media/BACKUPDBDEV/daily_backup/Dev_125"
...
check() {
    ...
    echo ""
    file_name_find=$(find ${daily_backup_path}/*/ -type f -name "${main_database_chosen}_[0-9]*.sql.gz" 2>/dev/null | sort -n);
