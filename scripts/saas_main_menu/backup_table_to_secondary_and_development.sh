...
backup() {
    ...
    do
        ...
        then
            temp_name="${path}/temp_${database}_${table}_${year}${month}${day}_${hour}${minute}${second}.sql.gz"
...
clear
echo "BACKUP TABLE TO SECONDARY AND DEVELOPMENT"
echo ""
