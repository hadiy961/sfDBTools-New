...
func (e *S2SExecutor) Execute(ctx context.Context) (*model.CopyResult, error) {
	...
	if err := e.svc.ValidateNotCopyToSelf(srcProfile, tgtProfile, sourceDB, targetDB, "s2s"); err != nil {
		return nil, err
	}
...
func (e *S2SExecutor) resolveDatabaseNames(ctx context.Context, srcClient interface{}) (sourceDB, targetDB string, err error) {
	if e.opts.SourceDB != "" && e.opts.TargetDB != "" {
